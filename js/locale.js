const LOCALIZATION = {
	...
	'pt':
	{
		'txtHtmlTitle':				'Mother Internacional',
		'txtTitleBottom':			'Internacional',
		'txtSubtitle':				'O Tudo-em-um Patcher de traduções de MOTHER',

		'txtBrowse':				'Procurar…',
		'txtNoRom':					'Por favor, selecione um ROM de MOTHER',

		'txtDropRom':				'Por favor solte qualquer MOTHER ROM aqui',
		...
		'txtFinalizing':			'Finalizando…',
		'txtEndMsg':				'Seu ROM patcheado está pronto!',

		'txtChecksum':				'CRC-32 checksum: %',

		'txtAllTranslations':		'Opções disponíveis para %:',
		'txtNoTranslation':			'Tradução não disponível',
		'txtShowAllVersions':		'Mostrar todos as versões',
		...
		'error_no_rom':				'Nenhum ROM especificado',
		'error_no_rom_info':		'Este ROM ainda não foi analisado',
		'error_already_patched':	'Este ROM já foi patcheado',
		'error_unknown_rom':		'ROM desconhecido',
		'error_no_rom_in_zip':		'Nenhum ROM foi encontrado dentro do arquivo zip',
		'error_crc_output':			'Wrong output ROM',
		'error_crc_input':			'Wrong input ROM',
		'error_patching':			'Deu erro no processo de patchear',
		'error_no_patch_route':		'Erro de tirar patch existente do ROM',
		'error_downloading':		'Erro de Download',
		'error_unzipping':			'Erro de descompactar zip',
		'error_invalid_patch':		'Patch não identificado',
		'error_crc_patch':			'Arquivo patch errado',
		'warning_too_big':			'Arquivos grades demais',
		'Not Found':				'O arquivo patch não foi encontrado',
		...
		'txtCreditsLegacy':			'Aplicativo legado',
		'txtCreditsPlayer':			'Jogador',
		'txtCreditsPlayerYou':		'Você!',

		'txtAboutIntro':			'Mother International é um aplicativo de patching online que pode traduzir qualquer jogo da série MOTHER.',
		'txtAboutFreeProg':			'Mother International é um aplicativo gratuito.\r\nEste aplicativo não está à venda.',
		'txtAboutSource':			'O código fonte da Mother International é % sob a ‰.',
		'txtAboutSourceGitHub':		'distribuido',
		...
		'txtAboutAllTranslations':	'Todas as traduções suportadas:',
		'txtAboutAllTransLabel':	'– Click para accessar a página –',
		'txtAboutAllTransNoSite':	'Nenhuma página registrada por %.',
		'txtAboutAllTransSiteAsk':	'Você quer visitar a página de % encontrado em ‰?',
		'txtAboutTranslator1':		'Se você for um tradutor, sinta-se livre para %!',
